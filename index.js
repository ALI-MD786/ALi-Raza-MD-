...
const ownerNumber = ['923450073465']
...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
  ...
  const sessdata = config.SESSION_ID.replace("raza~", '')
    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*Hᴇʟʟᴏ ᴛʜᴇʀᴇ 𝙰𝙻𝚒 𝚁𝚊𝚣𝚊-𝙼𝙳 ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 

*ᴋᴇᴇᴘ ᴏɴ ᴜsɪɴɢ 𝙰𝙻𝚒 𝚁𝚊𝚣𝚊 ᴍᴏᴅs🚩* 
...
https://github.com/ALI-MD786/ALi Raza-MD 

> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙰𝙻𝚒 𝚁𝚊𝚣𝚊🇵🇰`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/gn22ea.jpg` }, caption: up })
